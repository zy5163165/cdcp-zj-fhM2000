package org.asb.mule.probe.ptn.fenghuo.sbi;

import java.io.File;

import extendedManagedElementManager.ExtendedManagedElementMgr_I;
import extendedManagedElementManager.ExtendedManagedElementMgr_IHelper;
...
import org.asb.mule.probe.ptn.fenghuo.sbi.event.ObjectCreationNotification;
...
import extendedFlowDomainMgr.ExtendedFlowDomainMgr_IHelper;
import extendedMLSNMgr.ExtendedMLSNMgr_I;
import extendedMLSNMgr.ExtendedMLSNMgr_IHelper;
...
public class NmsSession extends NmsSession_IPOA implements StructuredPushConsumerOperations {
	...
	private static final String NameOfExtendedMLSN = "ExtendedMLSN";
	...
	private static final String NameOfExtFlowDomain = "ExtendedFlowDomain";
	...
	private extendedFlowDomainMgr.ExtendedFlowDomainMgr_I extendflowDomainMgr = null;
	private ExtendedMLSNMgr_I extendedMLSNMgrI = null;
	private TrailNtwProtMgr_I trailNtwProtMgr = null;

	private ExtendedManagedElementMgr_I extendedManagedElementMgrI = null;
	...
	public TrailNtwProtMgr_I getTrailNtwProtMgr() throws ProcessingFailureException {
		if (trailNtwProtMgr == null)
			trailNtwProtMgr = TrailNtwProtMgr_IHelper.narrow(getManager("TrailNtwProt"));
	...
	public ExtendedMLSNMgr_I getExtendedMLSNMgrI() throws ProcessingFailureException {
		if (extendedMLSNMgrI == null)
			extendedMLSNMgrI = ExtendedMLSNMgr_IHelper.narrow(getManager(NameOfExtendedMLSN));
		return extendedMLSNMgrI;
	}

	public ExtendedManagedElementMgr_I getExtendedManagedelementMgrI() throws ProcessingFailureException {
		if (extendedManagedElementMgrI == null)
			extendedManagedElementMgrI = ExtendedManagedElementMgr_IHelper.narrow(getManager("ExtendedManagedElement"));
		return extendedManagedElementMgrI;
	}
	...
	public extendedFlowDomainMgr.ExtendedFlowDomainMgr_I getExtendFlowDomainMgr() throws ProcessingFailureException {
		if (extendflowDomainMgr == null) {
			extendflowDomainMgr = ExtendedFlowDomainMgr_IHelper.narrow(getManager(NameOfExtFlowDomain));
		}

		return extendflowDomainMgr;
	}
